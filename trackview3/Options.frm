...
Private Sub Cmd_exit_Click()
    ...
    For Each DischName In txt_DischName()
        ...
        DischargerName(DischName.Index) = txt_DischName(DischName.Index)
    Next DischName
    ...
    For Each PLC In txt_PLCName()
        FileSaveSetting "SettingsNetwork", "Config", "PLCName" & Str(PLC.Index), txt_PLCName(PLC.Index).Text, NetPath
    ...
    FileSaveSetting "SettingsLocal", "RunAnotherProgram", "Use", Me.chkRunProg.Value, LocalPath
    FileSaveSetting "SettingsLocal", "RunAnotherProgram", "Path", Me.lblRunProg.Caption, LocalPath
    FileSaveSetting "SettingsLocal", "RunAnotherProgram", "MenuText", Me.txtRunProgMenuText.Text, LocalPath
...
Private Sub cmdRunProg_Click()
    ...
    lblRunProg.Caption = CommonDialog.FileName
...
Private Sub Form_Load()
    ...
    Dim PLC As TextBox
    For Each PLC In txt_PLCName()
        txt_PLCName(PLC.Index).Text = FileGetSetting("SettingsNetwork", "Config", "PLCName" & Str(PLC.Index), "PLC " & Str(PLC.Index), NetPath)
    Next PLC
    ...
    'Run another program menu
    Me.chkRunProg.Value = FileGetSetting("SettingsLocal", "RunAnotherProgram", "Use", "0", LocalPath)
    Me.lblRunProg.Caption = FileGetSetting("SettingsLocal", "RunAnotherProgram", "Path", "", LocalPath)
    Me.txtRunProgMenuText.Text = FileGetSetting("SettingsLocal", "RunAnotherProgram", "MenuText", "Run Prog Not Set!", LocalPath)
